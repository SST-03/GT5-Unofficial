...
public class MTETreeFarm extends GTPPMultiBlockBase<MTETreeFarm> implements ISurvivalConstructable {
     ...
     */
    public ItemStack findSapling() { // Changed to protected to make treeRender can access to it
     ...
     */
    public static EnumMap<Mode, ItemStack> getOutputsForSapling(ItemStack sapling) { // Changed to make tree render
                                                                                     // can work

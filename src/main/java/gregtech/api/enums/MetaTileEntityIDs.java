...
public enum MetaTileEntityIDs {
    ...
    Industrial_FormerPress_Modern(2815),
    Industrial_FishingPond_Modern(2816),
    Advanced_ImplosionCompressor_Modern(2817),
    AlgaeFarm_Modern(2818),
    Pyrolyse_Oven_Modern(2819),
    Drone_Centre_Modern(2820),
    Industrial_AutoChisel_Modern(2821),
    Industrial_ForgeHammer_Modern(2822),
    Amazon_Warehouse_Modern(2823),
    Industrial_RockBreaker_Modern(2824),
    Multiblock_Pump_Infinite_Modern(2825),
    Mega_Blast_Furnace_Modern(2826),
    Mega_Vacuum_Freezer_Modern(2827),
    Mega_Distillation_Tower_Modern(2828),
    Mega_Chemical_Reactor_Modern(2829),
    XL_Turbine_Steam_Modern(2830),
    XL_Turbine_SHSteam_Modern(2831),
    XL_Turbine_SCSteam_Modern(2832),
    XL_Turbine_Plasma_Modern(2833),
    XL_Turbine_Gas_Modern(2834),
    Large_Turbine_Steam_Modern(2835),
    Large_Turbine_SHSteam_Modern(2836),
    Large_Turbine_SCSteam_Modern(2837),
    Large_Turbine_Plasma_Modern(2838),
    Large_Turbine_Gas_Modern(2839),
    Large_Boiler_Bronze_Modern(2840),
    Large_Boiler_Steel_Modern(2841),
    Large_Boiler_Titanium_Modern(2842),
    Large_Boiler_TungstenSteel_Modern(2843),
    Extreme_combustion_Engine_Modern(2844),
    Combustion_Engine_Modern(2845),
    GT4_Thermal_Boiler_Modern(2846),
    UniversalChemicalFuelEngine_Modern(2847),
    Solid_Oxide_Fuel_Cell_MKI(2848),
    Solid_Oxide_Fuel_Cell_MKII(2849),
